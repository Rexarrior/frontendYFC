...
AJAX и COMET - две технологии, отвечающие за незаметное для пользователя общение с сервером. Их использование помозволяет динамически изменять содержимое страницы за счет подргружаемы данных без перезагрузки страницы или перенаправления пользователя.

AJAX (аббревиатура от «Asynchronous Javascript And Xml») – технология обращения к серверу  по инициативе клиентса без перезагрузки страницы
...
в JS для реализации AJAX служит XMLHttpRequest, однако почти каждый фреймворк предоставляет собственные срества для поддержки этой технологии. 
Технология COMET также может быть реализована через XMLHttpRequest с помощью особым способом построенных запросов. 

Рекомендуется уделить этой теме повышенное внимание, тщательно изучив соответствующие ей ссылки из следубщего блока. 

**Ссылки на ресурсы**
Необходимо изучить следующий материал: синтаксис javascript; встроенные методы для работы со строками, массивами, объектами; встроенные методы для работы с JSON; AJAX, XMLHttpRequest и его испольлзование для AJAX
...
1. [javascript.ru](https://learn.javascript.ru/js) - по мнению многих, лучший сайт для изучения javascript. Все темы снабжены подробным описанием с примерами, в завершении к каждой теме есть задачи на закрепление. Для новичка в js крайне рекомендуется пройти [курс](https://learn.javascript.ru/first-steps) основ языка. Для того, кто знаком с js, но хочет освежить навыки, будет полезен [этот](https://learn.javascript.ru/javascript-specials) справочник особенностей js
    1. [Туториал](https://learn.javascript.ru/first-steps) по основам js
    2. [Строки](https://learn.javascript.ru/string)
    3. [Методы массивов](https://learn.javascript.ru/array-methods) и [Итерация по массивам](https://learn.javascript.ru/array-iteration)
    4. [JSON](https://learn.javascript.ru/json#format-json)
    5. [AJAX и COMET](https://learn.javascript.ru/ajax-intro)
    6. [XMLHttpRequest](https://learn.javascript.ru/ajax-xmlhttprequest) 
    7. ["Чистая" реализация COMET](https://learn.javascript.ru/xhr-longpoll)
